...
[assembly: RegisterObjectType(typeof(InactiveAttendeeInfo), InactiveAttendeeInfo.OBJECT_TYPE)]

namespace Events
{
    /// <summary>
    /// Data container class for <see cref="InactiveAttendeeInfo"/>.
    /// </summary>
    [Serializable]
    public partial class InactiveAttendeeInfo : AbstractInfo<InactiveAttendeeInfo, IInactiveAttendeeInfoProvider>
    {
        /// <summary>
        /// Object type.
        /// </summary>
        public const string OBJECT_TYPE = "events.inactiveattendee";


        /// <summary>
        /// Type information.
        /// </summary>
        public static readonly ObjectTypeInfo TYPEINFO = new ObjectTypeInfo(typeof(InactiveAttendeeInfoProvider), OBJECT_TYPE, "Events.InactiveAttendee", "ActiveAttendeeID", "ActiveAttendeeLastModified", "ActiveAttendeeGuid", null, "FirstName", null, null, "ParentEventID", EventSessionInfo.OBJECT_TYPE)
        {
            ModuleName = "Events",
        ...
        public virtual int ParentEventID
        {
            ...
            set
            {
                SetValue("ParentEventID", value, 0);
            }
        }
        ...
        protected InactiveAttendeeInfo(SerializationInfo info, StreamingContext context)
        ...
        /// <summary>
        /// Creates an empty instance of the <see cref="InactiveAttendeeInfo"/> class.
        /// </summary>
        public InactiveAttendeeInfo()
            : base(TYPEINFO)
        {
        }
        ...
        /// <summary>
        /// Creates a new instances of the <see cref="InactiveAttendeeInfo"/> class from the given <see cref="DataRow"/>.
        /// </summary>
        /// <param name="dr">DataRow with the object data.</param>
        public InactiveAttendeeInfo(DataRow dr)
            : base(TYPEINFO, dr)
        {
        }
    }
