...
#nullable enable
        ...
        /// re-executing the request pipeline using an alternate path. This path may contain a '{0}' placeholder 
        /// for the status code.
        /// </summary>
        /// <param name="app">App builder.</param>
        /// <param name="pathFormat">Format pattern with two placeholders: the culture and the status code.</param>
        /// <param name="queryFormat">Query format</param>
        /// <returns></returns>
        public static IApplicationBuilder UseCustomStatusCodePagesWithReExecute(
