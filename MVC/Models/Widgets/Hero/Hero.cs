...
[assembly: RegisterWidget("UMCHospital.Widgets.Hero", "Standard Hero", typeof(HeroProperties), customViewName: "Widgets/Hero/_Hero", IconClass = "icon-l-img-3-cols-3", AllowCache = true)]

namespace MVC.Models.Widgets.Hero
{
    public class HeroProperties : IWidgetProperties
    {
        //HERO PROPERTIES
        ...
        [EditingComponent(TextInputComponent.IDENTIFIER, Order = 1, Label = "Sub Heading")]
        public string SubHeading { get; set; }

        [EditingComponent(MediaFilesSelector.IDENTIFIER, Order = 2, Label = "Image")]
        public IEnumerable<MediaFilesSelectorItem> Image { get; set; }

        [EditingComponent(MediaFilesSelector.IDENTIFIER, Order = 3, Label = "Mobile Image")]
